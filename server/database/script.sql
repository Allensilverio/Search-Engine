...
CALL spInsertPage("https://www.test.com", "Test Title", "Test Description", "https://www.test.com/icon.ico", "Test,Video Games,Books,Music,Video", "es", 100);
CALL spInsertPage("https://www.google.com", "Google", "El motor de búsqueda más utilizado en el mundo.", "https://www.google.com/favicon.ico", "Motor de búsqueda, Google, Búsqueda en línea, Internet, Buscar", "Multi", 90);
CALL spInsertPage("https://www.facebook.com", "Facebook", "La red social más grande y popular.", "https://www.facebook.com/favicon.ico", "Red social, Facebook, Amigos, Comunicación, Socializar", "Multi", 90);
CALL spInsertPage("https://www.youtube.com", "YouTube", "La plataforma de videos en línea más grande y utilizada.", "https://www.youtube.com/favicon.ico", "Videos en línea, YouTube, Entretenimiento, Subir videos", "Multi", 92);
CALL spInsertPage("https://www.amazon.com", "Amazon", "Uno de los principales sitios de comercio electrónico del mundo.", "https://www.amazon.com/favicon.ico", "Comercio electrónico, Amazon, Compras en línea, Productos, Tienda en línea", "Multi", 88);
...
CALL spInsertPage("https://www.wikipedia.org", "Wikipedia", "Una enciclopedia en línea de acceso abierto.", "https://www.wikipedia.org/static/favicon/wikipedia.ico", "Enciclopedia en línea, Wikipedia, Conocimiento, Colaborativo, Información", "Multi", 94);

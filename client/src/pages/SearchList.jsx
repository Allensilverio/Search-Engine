...
export default function SearchList({ totalResultados }) {

    return (
        <div className='flex flex-col items-center justify-center rounded-3xl bg-gradient-to-b from-white/20 backdrop-blur-md drop-shadow-xl border-[0.5px] border-white/10 space-y-16 my-auto py-10 pl-32 pr-96'>
            ...
            <div className='w-full space-y-2'>
                ...
                <p className='text-white/70 text-[14px]'>Se han encontrado {totalResultados.toLocaleString()} resultados</p>

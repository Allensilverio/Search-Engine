...
export default function WebsiteCard({Icon, Title, Url, Keywords, Description}) {
  ...
  return (
    <div>
        <div>
          <div className='flex flex-row space-x-3 pl-0 my-6 '>
            <div className='bg-white w-[48px] h-[48px] rounded-3xl'>
              <img src={Icon} alt='logo' className='w-[48px] h-[48px] rounded-3xl' />
            </div>
            <div className='flex flex-col justify-left'>
              <h1 className='text-[15px] font-poppins font-regular text-white'>{Title}</h1>
              <a
                ...
                className='text-[14px] text-Rosado hover:underline' 
              >
                {Url}
              </a>              </div>
          </div>
